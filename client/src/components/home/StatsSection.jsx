...
export default function StatsSection() {
  return (
    <section className="py-12 sm:py-16 bg-primary-600 dark:bg-primary-900">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 leading-tight">{stat.value}</div>
