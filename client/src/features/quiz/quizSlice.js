...
export const fetchQuizById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const { data } = await quizAPI.getStudentQuizById(id);
      return data.data || data;
    } catch (err) {
...
export const { setQuizAnswer, setCurrentQuiz, setQuizQuestion, clearQuizState, clearCurrentQuiz } =
  quizSlice.actions;
