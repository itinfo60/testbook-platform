    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="card p-5 sm:p-8 text-center mb-4 sm:mb-6">
        ...
        <div className="relative inline-flex items-center justify-center my-4 sm:my-6">
          ...
          <div className="absolute text-center">
            <div className="text-2xl sm:text-3xl font-bold text-dark-900 dark:text-white">{Math.round(pct)}%</div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
        <div className="card p-3 sm:p-4 text-center">
          ...
          <div className="text-lg sm:text-xl font-bold text-dark-900 dark:text-white">{correctAnswers || 0}</div>
          <div className="text-xs text-dark-400">Correct</div>
        </div>
        <div className="card p-3 sm:p-4 text-center">
          <HiXCircle className="h-5 w-5 sm:h-6 sm:w-6 text-red-500 mx-auto mb-1" />
          <div className="text-lg sm:text-xl font-bold text-dark-900 dark:text-white">{incorrectAnswers || 0}</div>
        ...
        <div className="card p-3 sm:p-4 text-center">
          ...
          <div className="text-lg sm:text-xl font-bold text-dark-900 dark:text-white">{unanswered || 0}</div>
          <div className="text-xs text-dark-400">Skipped</div>
        </div>
        <div className="card p-3 sm:p-4 text-center">
          <div className="text-xl sm:text-2xl mb-1">⏱️</div>
          <div className="text-lg sm:text-xl font-bold text-dark-900 dark:text-white">{timeTaken || '-'}</div>
        ...
        <div className="card p-4 flex items-center justify-around mb-4 sm:mb-6">
          {rank && (
            <div className="text-center">
              ...
              <div className="text-xl sm:text-2xl font-bold text-dark-900 dark:text-white">#{rank}</div>
            </div>
          )}
          {percentile && (
            <div className="text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <Link to="/tests" className="btn-outline text-center">Back to Tests</Link>
        <Link to="/leaderboard" className="btn-primary text-center">View Leaderboard</Link>
      </div>
    </div>
  );
}
