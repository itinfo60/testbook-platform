    ...
    >
      <div className="flex items-start gap-3 mb-4">
        ...
        <div className="flex-shrink-0">
          {wasAnswered ? (
            isCorrect ? (
              <HiCheckCircle className="h-6 w-6 text-secondary-500" />
            ) : (
              <HiXCircle className="h-6 w-6 text-red-500" />
            )
          ) : (
            <span className="text-xs badge bg-dark-100 text-dark-500 dark:bg-dark-700">
              Skipped
            </span>
          )}
        </div>
          ...
          return (
            ...
            >
              ...
              <span
                className={
                  isCorrectOption
                    ? 'text-secondary-700 dark:text-secondary-400 font-medium'
