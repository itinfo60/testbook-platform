  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-5 sm:mb-6">
        <SearchBar value={search} onChange={setSearch} placeholder="Search tests..." className="flex-1 min-w-0" />
      </div>

      <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0 mb-6">
        <Tabs tabs={categoryTabs} activeTab={activeCategory} onChange={setActiveCategory} className="min-w-max sm:min-w-0" />
      </div>
