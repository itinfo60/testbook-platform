...
export const resetPassword = createAsyncThunk('auth/resetPassword', async ({ token, ...rest }, { rejectWithValue }) => {
  try {
...
const authSlice = createSlice({
  ...
  reducers: {
    setCredentials: (state, action) => {
      ...
      if (refreshToken) { state.refreshToken = refreshToken; localStorage.setItem('refreshToken', refreshToken); }
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(updateProfile.fulfilled, (s, a) => { s.loading = false; s.user = a.payload; s.message = 'Profile updated'; })
      ...
      .addCase(forgotPassword.fulfilled, (s, a) => { s.loading = false; s.message = a.payload; })
      ...
      .addCase(getProfile.pending, s => { s.loading = true; })
      .addCase(getProfile.fulfilled, (s, a) => { s.loading = false; s.user = a.payload; s.initialized = true; })
      .addCase(getProfile.rejected, (s, a) => { s.loading = false; s.initialized = true; })
