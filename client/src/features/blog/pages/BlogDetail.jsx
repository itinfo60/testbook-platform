...
export default function BlogDetail() {
  ...
  return (
    <article className="min-h-screen bg-white dark:bg-dark-950 pb-20">
      {/* Hero Section */}
      <div className="relative h-[280px] sm:h-[400px] md:h-[500px] w-full">
        <img
        ...
        <div className="absolute bottom-0 left-0 w-full p-4 sm:p-6 md:p-12">
          <div className="max-w-4xl mx-auto">
            <Link to="/blog" className="inline-flex items-center gap-2 text-primary-400 font-bold mb-4 sm:mb-6 hover:text-primary-300 transition-colors text-sm sm:text-base">
              <HiArrowLeft /> Back to Insights
            </Link>
            <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold text-white mb-4 sm:mb-6 leading-tight font-display">
              {currentBlog.title}
            </h1>
            <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-dark-300">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mt-8 sm:mt-12">
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12">
          ...
          <div className="flex-1">
            ...
            <div className="mt-10 sm:mt-16 pt-6 sm:pt-8 border-t border-dark-100 dark:border-dark-800 flex flex-wrap items-center justify-between gap-4 sm:gap-6">
