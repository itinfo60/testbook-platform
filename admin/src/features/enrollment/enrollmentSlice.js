...
export const exportEnrollments = createAsyncThunk(
  'enrollments/export',
  async (params, { rejectWithValue }) => {
    try {
...
const enrollmentSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(exportEnrollments.pending, (state) => {
        state.exporting = true;
      })
      .addCase(exportEnrollments.fulfilled, (state) => {
        state.exporting = false;
      })
      .addCase(exportEnrollments.rejected, (state) => {
        state.exporting = false;
      });
  },
});
