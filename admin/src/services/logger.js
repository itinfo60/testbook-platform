/**
 * CivicsEdu Admin Telemetry & Action Logger
...
class FrontendLogger {
  ...
  init() {
    ...
    this.info('APP_START', `${this.app.toUpperCase()} portal session initialized`, {
  ...
  pageView(path, title) {
    this.action('PAGE_VIEW', `Visited Admin ${path}`, { title: title || document.title, path });
  }
...
const adminLogger = new FrontendLogger('admin');
